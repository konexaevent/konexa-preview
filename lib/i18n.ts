...
const messages: Record<Locale, Messages> = {
  ca: {
    ...
    avatarHelp: "La foto de perfil es puja des de la teva galeria.",
    avatarFile: "Pujar nova foto",
    avatarFileHelp: "Tria una imatge de la teva galeria per actualitzar el perfil.",
    firstName: "Nom",
    lastName: "Cognoms",
  ...
  es: {
    ...
    avatarUrl: "Foto de perfil",
    avatarHelp: "La foto de perfil se sube desde tu galeria.",
    avatarFile: "Subir nueva foto",
    avatarFileHelp: "Elige una imagen de tu galeria para actualizar el perfil.",
    firstName: "Nombre",
    lastName: "Apellidos",
  ...
  en: {
    ...
    avatarHelp: "Your profile photo is uploaded from your gallery.",
    avatarFile: "Upload new photo",
    avatarFileHelp: "Choose an image from your gallery to update your profile.",
